...
var $dp=null;if(!window.$){function $(id) {return document.getElementById(id);}}
...
while(obj=obj.offsetParent){if(obj.style.position=='absolute'||obj.style.position=='relative'){break;}
top+=obj.offsetTop;
left+=obj.offsetLeft;
