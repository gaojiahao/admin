...
<head>
    ...
    <link rel="stylesheet" href="/Public/Book/SignApplication/Css/signapplication.css">
...
<div id="main-container" class="main-container p-relative">
            ...
            <div class="creator-right fr p-relative">
                <div class="r-works work-mananer">
                    ...
                    <div class="pro-apply">
                        ...
                        <div class="pro_work">
                            <label>选择作品：</label>
                            <select name="allbook" id="allbook">
    ...
    <div class="bgall">
        <div class="bgall-content apply-success">
            <div class="text-tips">
                <div>
                    <i class="sucess-icon"><img src="/Public/Book/SignApplication/images/cat-icon.png" alt=""></i>
                    <span>申请成功</span>
                </div>
                <p>我们将在3个工作日内反馈申请进度，请耐心等候。</p>
            </div>
            <div class="close_btn">
                <img src="/Public/Book/SignApplication/images/close.png" alt="">
            </div>
        </div>
        <!--申请失败-->
        <div class="bgall-content apply-fail">
            <div class="text-tips">
                <div>
                    <i class="fail-icon"><img src="/Public/Book/SignApplication/images/c-icon.png" alt=""></i>
                    <span>申请失败</span>
                </div>
                <p>您本周已申请过签约，请下周再提交申请</p>
            </div>
            <div class="close_btn">
                <img src="/Public/Book/SignApplication/images/close.png" alt="">
            </div>
