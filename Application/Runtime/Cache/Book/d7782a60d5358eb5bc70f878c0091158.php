...
<head>
    ...
    <link rel="stylesheet" href="/Public/Book/Createnovel/Mynovel/Css/mynovel.css">
    ...
    <script src="/Public/Book/Createnovel/Mynovel/Js/mynovel.js"></script>
            ...
            <div class="creator-right fr p-relative">
                ...
                <div class="myWorks comic-myworks">
                    ...
                    <div class="myworks-content comic-myworks-content">
                        ...
                        <div class="comic-list-work work-sums clearfix">
                            <div class="work-sums-title fl">
                                <i>小说列表</i>
                                <i>共<?php echo ($count); ?>部小说</i>
                            </div>
                            <div class="work-sums-title-right fr clearfix">
                                <div class="work-search fl p-relative">
                                    <input type="text">
                                    <a class="p-absolute"><img src="/Public/Book/Createnovel/Mynovel/images/searcj-icon.png" alt=""></a>
                                </div>
                                <div class="new-works fl anbtn">
                                    <a href="/Book/Createnovel/novelstep"><b>新建小说</b></a>
                                </div>
                            </div>
                        </div>
                        <div class="novel-list-work-content list-work-content">
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><dl class="mod_of clearfix">
                                ...
                                <?php if(($vol["besure"]) == "通过审核!"): ?><a class="p-relative" href="/Book/AuthorNovelmeg/index?vv=<?php echo ($vol["val"]); ?>">
                                ...
                                <dd class="fl work-messages-details clearfix">
                                    ...
                                    <div class="work-tab-btn">
                                        <span class="c-work current-state-works"> <a href="/Book/WorkManager/index?lav=<?php echo ($vol["val"]); ?>">作品管理</a></span>
                                        <span class="c-section current-state-works"><a href="/Book/NovelManager/novchpmag?lav=<?php echo ($vol["val"]); ?>">章节管理</a></span>
                                        <span class="c-apply current-state-works"><a href="/Book/Novelwelfare/index?lav=<?php echo ($vol["val"]); ?>">福利申请</a></span>
                    ...
                    <div class="work-confirm-tips">
                        <i><img src="/Public/Book/Createnovel/Mynovel/images/confirm-icon.png" alt=""></i>
                        <i><b>审核信息:</b></i>
