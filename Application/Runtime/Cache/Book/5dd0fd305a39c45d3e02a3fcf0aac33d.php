...
<head>
    ...
    <link rel="stylesheet" href="/Public/Book/AuthorNovelmeg/Css/aunovelmsg.css">
    <script src="/Public/Book/Static/Js/jquery-3.0.0.js"></script>
    <script src="/Public/Book/Static/Js/loginreg.js"></script>
    <script src="/Public/Book/AuthorNovelmeg/Js/aunovelmsg.js"></script>
    <script src="/Public/Book/AuthorNovelmeg/Js/modernizr.min.js"></script>
        ...
        <div class="mainContent w1174">
            <div class="part-one clearfix">
                <div class="part-right fl">
                    <div class="author-messge bg-fff clearfix">
					<?php if(is_array($Formcreatedata)): $i = 0; $__LIST__ = $Formcreatedata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><div class="shuming-title clearfix">
                            <div class="sm-head fl"><?php echo ($vol["title"]); ?></div>
                            <div class="biaoqian fl clearfix">
                        ...
                        <div class="conmic-pic-right fl">
                            ...
                            <div class="author-picture p-relative">
                                <img src="<?php echo ($vol["photopath"]); ?>" alt="" height="299" width="225">
                                <i class="loading p-absolute"><img src="/Public/Book/AuthorNovelmeg/images/loading.png" alt=""></i>
                            </div>
                        </div>
                        ...
                        <div class="comic-tex-left fl">
                            ...
                            <p class="review">
                                <span id="score-num">请您评分 :</span>
                                     <span id="UserStart" class="stars">
										 <?php $__FOR_START_1199024380__=0;$__FOR_END_1199024380__=$modenumber;for($i=$__FOR_START_1199024380__;$i < $__FOR_END_1199024380__;$i+=1){ ?><i id="star1" class="light-star" sp="<?php echo ($i+1); ?>" onclick="star(this)"></i><?php } ?>
                                         <?php $__FOR_START_672232008__=0;$__FOR_END_672232008__=5-$modenumber;for($i=$__FOR_START_672232008__;$i < $__FOR_END_672232008__;$i+=1){ ?><i id="star5" class="prey-star" sp="<?php echo ($i+$modenumber+1); ?>"  onclick="star(this)"></i><?php } ?>
                                    </span>
                            ...
                            <p class="line-two">
                                <span>作者:  <i><?php echo ($vol["author"]); ?></i>&nbsp;<em>（共著<?php echo ($Formhowcreate); ?>部作品 完结<?php echo ($Formfinishcreate); ?>部）</em></span>

                            </p>
                            <?php if(($vol["look"]) == "1"): ?><p class="open">
                               <span>开放：&nbsp;<em>本书允许非商业用途下自由开放同人创作</em></span>
                            </p><?php endif; ?>
                            <p class="renqi">
                                <span>人气:  <?php echo ($Formoods); ?></span>
                                <span>字数:   <?php echo ($vol["quatityword"]); ?></span>
                                <span id="renqi">吐槽: <?php echo ($Formsaylove); ?></span>
                            ...
                            <div class="book-function">
                                  ...
                                  <ul class="info-book">
										<?php if(is_array($Formcreatedata)): $i = 0; $__LIST__ = $Formcreatedata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li><a href="/Book/LookNovel/index?cy=<?php echo ($vol["val"]); ?>" target="_blank">开始阅读</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                        <li>|</li>
                                ...
                                <div class="share">
                                        <span class="sent-mess p-relative">
                                            ...
                                            <div class="share-other p-absolute"  style="height:30px;">
												...
												<a  href="http://service.weibo.com/share/share.php?&url=http://www.thinkphp.org/Book/Authormessge/index?vv=58&title=大家都在看《<?php echo ($vol["title"]); ?>》,快快加入我们吧!" target="_blank"><img src="/Public/Book/Authormessge/images/weiboshare.png" alt="" height="16" width="16"></a>
                    ...
                    <div class="gift-give bg-fff m-t15">
                        <div class="gift-giving-head v-head p-t24">
                                <span class="g-sent">
                                    <i><img src="/Public/Book/AuthorNovelmeg/images/gift-icon.png" alt=""></i>
                                    礼物打赏
                                </span>
                            <span class="gift-text">其实我只是想证明自己爱过，顺便挤上粉丝榜</span>
                                <span class="fensi-active">
                                    <i><img src="/Public/Book/AuthorNovelmeg/images/fensi-icon.png" alt=""></i>
                                    本书粉丝动态
                                </span>
                        </div>
                    ...
                    <div class="part-two bg-fff m-t15 clearfix">
                        ...
                        <span class="chapter">
                            <i><img src="/Public/Book/AuthorNovelmeg/images/chapter-icon.png" alt=""></i>
                            章节列表
                        </span>
                        <span class="zj-list">
                            上次看到：
                            <?php if(is_array($historygo)): $i = 0; $__LIST__ = $historygo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><a href="/Book/LookNovel/index/cy/<?php echo ($vol["val"]); ?>/p/<?php echo ($vol["pp"]); ?>.html" target="_blank">[<?php echo ($vol["looked"]); ?>]</a><?php endforeach; endif; else: echo "" ;endif; ?> 
							<?php if(is_array($hh)): $i = 0; $__LIST__ = $hh;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><a href="/Book/LookNovel/index?cy=<?php echo ($vals); ?>" target="_blank">[<?php echo ($vol["a"]); ?>]</a><?php endforeach; endif; else: echo "" ;endif; ?>
							&nbsp;&nbsp;最新话：
                             <a href="/Book/LookNovel/index/cy/<?php echo ($vals); ?>/p/<?php echo ($counted); ?>.html" target="_blank">[<?php echo ($nowpassagetitle); ?>]</a>  &nbsp;&nbsp;<?php echo ($nowtime); ?>
                        </span>
                        <span class="zx">
                            正序
                            <i class="upList"><img src="/Public/Book/AuthorNovelmeg/images/up.png" alt=""></i>
                            <i class="downList" style="display: none"><img src="/Public/Book/AuthorNovelmeg/images/down.png" alt=""></i>
                        </span>
                        </div>
                        <div class="allChapter">
                            <ul class="chapter-lists-content chapter1-20" id="chapter1-20">

                                <!--<li class="m-chapter-item border">
                                    <a href="#">
                                        <span class="f-toe">075&nbsp;坠机惊魂</span>
                                    </a>
                                </li>-->
     
                               
                            </ul>
                            <div class="chapter_con_more" id="btnChapterMore">
                                <a href="javascript:;">
                                    <span class="addMore"><img src="/Public/Book/AuthorNovelmeg/images/add.png" alt="">&nbsp;查看全部章节</span>
                                </a>
                            </div>
                            <ul class="clearfix endChapter" id="endChapters">
								
                                <!--<li class="m-chapter-item border">
                                    <a href="#">
                                        <span class="f-toe">001&nbsp;爆红网络</span>
                                    </a>
                                </li>-->
                        ...
                        <div class="informList" id="informList" style="display: none">
							...
							<?php if(is_array($Formauthordata)): $k = 0; $__LIST__ = $Formauthordata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><div class="mainList" flag="volumes">
                                <div class="clearfix mainListTop">
                                    <div class="mainListT1 clearfix">
                                        <i class="fl"></i>
                                        <span class="fl"><?php echo ($vol["section"]); ?></span>
                                    </div>
                                </div>
                                <div class="mainList_In">
                                    <div class="chapter_con">
                                        <ul class="clearfix" flag="chapters" id="ps<?php echo ($vol["authornumber"]); ?>">
											
                                            <!--<li class="m-chapter-item">
                                                <a href="#">
                                                    <span class="f-toe">075&nbsp;坠机惊魂 <img src="/Public/Book/AuthorNovelmeg/images/vip.png" alt=""></span>
                                                </a>
                                            </li>
                                            <li class="m-chapter-item">
                                                <a href="#">
                                                    <span class="f-toe">072&nbsp;血与狂</span>
                                                </a>
                                            </li>-->
                    ...
                    <ul class="work-piction">
						 <?php if(is_array($Formtotalsums)): $k = 0; $__LIST__ = $Formtotalsums;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><li>
                            <a class="cartoon-girl" href="/Book/AuthorNovelmeg/index?vv=<?php echo ($vol["val"]); ?>">
                                <img src="<?php echo ($vol["photopath"]); ?>" alt=""style="width:145px;height:199px;border-radius:10px;">
                                <div class="pic-bg">
                                    <h3 class="bg-head">
                    ...
                    <div class="talk-zone-head">
                        ...
                        <div class="exp_list">
							<div class="clearfix"><span class=" x_close"></span></div>
                        ...
                        <ul id="firstcoment">
							<?php if(is_array($Formcomentdata)): $k = 0; $__LIST__ = $Formcomentdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><li class="li1">
                                <div class="talker-avatar">
                                    <i class="i_avata" ><img src="<?php echo ($vol["photo"]); ?>" alt="" height="51" width="51"></i>
                ...
                <div class="part-left fl">
                    <div class="left-sidebar-mess p-relative">
                        ...
                        <div class="videoer-mess videoer">
                            <img src="/Public/Book/AuthorNovelmeg/images/video-mess.png" alt="">
                            <b>主创档案</b>
                        </div>
                         <?php if(is_array($Formquantitydata)): $i = 0; $__LIST__ = $Formquantitydata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><div class="per-avatar">
                                ...
                                <?php if(is_array($ee)): $i = 0; $__LIST__ = $ee;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><div class="dashen l-space t-align"><?php echo ($datadown); ?></div><?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <hr>
                        <div class="BookInfoCalendar">
                            <div class="BookInfoCalendar_Title">已连续更新：0天 0万字</div>
                            <div class="BookInfoCalendar_Main">
                                <ul class="calendar_List clearfix">
								  <?php $__FOR_START_25021199__=1;$__FOR_END_25021199__=31;for($i=$__FOR_START_25021199__;$i < $__FOR_END_25021199__;$i+=1){ ?><li>
                                        <i></i>
                                        <div class="BookInfoCalendar_Icon1"></div>
                                        <div class="clearfix CalendarTitle" style="display: none">
                                            <div class="fl CalendarTitle_L"></div>
                                            <!--<div class="fl CalendarTitle_C">01-16更新2章，共计4223字</div>-->
                                              <div class="fl CalendarTitle_C"><?php echo ($i); ?></div>
                                            <div class="fl CalendarTitle_R"></div>
                                        </div>
                                    </li><?php } ?>
                        ...
                        <div class="fensi-rank">
                            <div class="fensi-head clearfix">
                                <div class="head-title l-space">
                                        <span>
                                            <img src="/Public/Book/AuthorNovelmeg/images/fensi.png" alt="">
                                            粉丝排行榜
                                        </span>
                            ...
                            <?php if(is_array($Formmyfans)): $k = 0; $__LIST__ = $Formmyfans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><div class="rank-bottom clearfix">
                                <div class="my-rank rank-fensi">
                                    <p class="rank-num r_num"><?php echo ($p+1); ?></p>
                                    <p class="text-rank r_text">我的排名</p>
                                </div>
                                <div class="line"></div>
                                <div class="my-fensi rank-fensi">
                                    <p class="fensi-num r_num"><?php echo ($vol["valued"]); ?></p>
                                    <p class="text-fensi r_text">我的粉丝值</p>
                                </div>
                            </div><?php endforeach; endif; else: echo "" ;endif; ?>
                            <?php if(is_array($yy)): $k = 0; $__LIST__ = $yy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k;?><div class="rank-bottom clearfix">
                                <div class="my-rank rank-fensi">
    ...
    <div class="baoyangAll" style="display: none">
        ...
        <div class="zhuliAll" style="display: none">
            <div class="zhuli-content pulic-content">
                <i><img src="/Public/Book/Authormessge/images/zhuli1.png" alt=""></i>
...
//    弹框前循环点击礼物
    $(".g-con-ul li").each(function (i) {
        $(this).click(function () {
            ...
            $price = $(this).find(".bi-num").html();//获取礼物比例值
            $num = Number($price)*10;
			...
			$("#liuyan").attr("placeholder",$hoder);//textarea输入框内容
            $(".chooseNum li").eq(0).addClass("ds_active").siblings().removeClass("ds_active");//数量值框初始化
            $(".imgList li").eq(i).addClass("bor-current").siblings().removeClass("bor-current");//选中弹框后的礼物
            $("#dsnumCoin").val("自定义");
...
<script>
    //    回复1
    $(function () {
        $(".li1 .reply").click(function () {
            $(".li1 .review-content").toggle()
//            $(".after-write-back").css("display","none")
    ...
    $(function () {
        ...
        $("#sent-talking").click(function () {
            $(".li1 .review-content").css("display","none")
            $(".li1 .after-write-back").css("display","block")
        })
    })
</script>
...
<script>
    ...
    $(".by_close_suc").click(function () {
        $(".baoyangAll").hide()
         window.location.href='/Book/AuthorNovelmeg/index?vv=<?php echo ($vals); ?>';
    });
    //    包养失败
...
<script>
    ...
    var m1,d1,myDate,lastDay,datetext;
    var $li = $(".calendar_List li");
    for(var i=0;i < 30;i++){
        m1 = m.toString().length == 1 ? "0" + m : m;
        d1 = d.toString().length == 1 ? "0" + d : d;
        d --;
        if(d == 0){
            m = m-1;
            ...
            d = lastDay;
            $li.eq(i).find("i").html(m1 + "-" + d1);
        }else {
            $li.eq(i).find("i").html(m1 + "-" + d1);
        }
        datetext = $li.eq(i).find("i").html();
        //$(".CalendarTitle_C").eq(i).html(datetext+"更新2章，共计4223字");
...
function saybackfour(obj){
	...
	if(content==""){
	 ...
	 $.post(
		'/Book/AuthorNovelmeg/saybackfour',
...
$.post(
		'/Book/AuthorNovelmeg/urge?val=<?php echo ($vals); ?>',
...
$.post(
		'/Book/AuthorNovelmeg/included?val=<?php echo ($vals); ?>',
...
$.post(
		'/Book/AuthorNovelmeg/moped?val=<?php echo ($vals); ?>',
...
if(paymoney==""){
	...
	$.post(
		'/Book/AuthorNovelmeg/gifts?val=<?php echo ($vals); ?>',
...
<script>
	var val = "<?php echo ($vals); ?>";
	$.post(
		'/Book/AuthorNovelmeg/passage',
		{"val":val},
		function(data){
			var obj = eval("("+data+")");
			for(i=0;i<obj.length;i++){
				var longer = obj.length-8;
				if(obj.length<=8){
					$("#btnChapterMore").css('display','none');
				}
				var authornumber=obj[i]['authornumber'];
				var did ="ps"+authornumber;
				var ided = "#"+did+"";
				var passagetitle=obj[i]['passagetitle'];
				var vipe = obj[i]['vipe'];
				var k=parseInt(i)+1;
				var infor ="/Book/LookNovel/index/cy/"+val+"/p/"+k+".html"
				if(vipe==1){
					//alert(vipe);
				var html="";
						html +="<li class='m-chapter-item'>";
						html +="<a href="+infor+">";
						html +="<span class='f-toe'>"+passagetitle+"<img src='/Public/Book/AuthorNovelmeg/images/vip.png'></span>";
						html +="</a>";
						html +="</li>";
						//alert(ided);
					$(ided).prepend(html);
					...
					if(i<=7){	
			    var htmltwo="";
						htmltwo +="<li class='m-chapter-item border'>";
						htmltwo +="	<a href="+infor+">";
						htmltwo +="		<span class='f-toe'>"+passagetitle+"<img src='/Public/Book/AuthorNovelmeg/images/vip.png'></span>";
						htmltwo +="	</a>";
						htmltwo +="</li>";
						$("#endChapters").prepend(htmltwo);
					   }
					   if(longer>0){
						   if(i>=longer){
						   var htmlthree="";  
							htmlthree +="<li class='m-chapter-item border'>";
							htmlthree +="	<a href="+infor+">";
							htmlthree +="		<span class='f-toe'>"+passagetitle+"<img src='/Public/Book/AuthorNovelmeg/images/vip.png'></span>";
							htmlthree +="	</a>";
							htmlthree +="</li>";
							$("#chapter1-20").prepend(htmlthree);
							}
					  }
				 ...
				 if(vipe==0){
				 var htmlone="";	
						htmlone +="<li class='m-chapter-item'>";
						htmlone +="<a href="+infor+">";
						htmlone +="<span class='f-toe'>"+passagetitle+"</span>";
						htmlone +="</a>";
						htmlone +="</li>";
						$(ided).prepend(htmlone);
					if(i<=7){	
			    var htmltwo="";
						htmltwo +="<li class='m-chapter-item border'>";
						htmltwo +="	<a href="+infor+">";
						htmltwo +="		<span class='f-toe'>"+passagetitle+"</span>";
						htmltwo +="	</a>";
						htmltwo +="</li>";
						$("#endChapters").prepend(htmltwo);
					   }
					   if(longer>0){
						   ...
						   var htmlthree="";  
							htmlthree +="<li class='m-chapter-item border'>";
							htmlthree +="	<a href="+infor+">";
							htmlthree +="		<span class='f-toe'>"+passagetitle+"</span>";
							htmlthree +="	</a>";
							htmlthree +="</li>";
							$("#chapter1-20").prepend(htmlthree);
							}
