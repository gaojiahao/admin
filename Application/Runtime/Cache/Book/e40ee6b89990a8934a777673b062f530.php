                ...
                <div class="comic-step2"  style="display:block;">
                    ...
                    <div class="create-item-step ">
                        <div class="step2-message info-message">
                            <form method="post" action="/Book/Modifycomi/updated?sub=<?php echo ($sub); ?>&&val=<?php echo ($val); ?>&&authornumber=<?php echo ($authornumber); ?>" name="myform1" id="myform1">
                                ...
                                <div class="comic-name">
                                    <label>
                                        ...
                                        <input class="comic-input" type="text" id="passagetitle" name="passagetitle" value="<?php echo ($Formauthordata); ?>">
                                    </label>
						...
						<!--以下是图片上传-->                 
											...
											<div id="uploadimg">
												...
												<div class="jq22">
													   <ul class="upsection_con_li ">
														   <?php if(is_array($threedataed)): $i = 0; $__LIST__ = $threedataed;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li  class='upload_append_list' id= "<?php echo ($vol["id"]); ?>">
																<a  href='#' class='imgBox'>
																	<img  class='upload_image'  src="<?php echo ($vol["path"]); ?>" style='width:118px;height:160px;' />
																</a>
															  <p class='comic_name'>
																	<input type='hidden' id='picturegraph' name='photoval' value="<?php echo ($vol["val"]); ?>">
																	<input type='hidden' id='picturephotopath' name='pathphoto[]' value="<?php echo ($vol["path"]); ?>">
																	<input type='hidden' id='picturephotoid' name='pathphoto[]' value="<?php echo ($vol["id"]); ?>">
																	<input class='imgselect'  type='checkbox' name='imgselect' value="<?php echo ($vol["id"]); ?>">
																</p>
							...
							<div class="chapter-face">
								...
								<div class="logoFace clearfix">
									<div class="logoPicture fl" id="logoPicture">
										<img src="<?php echo ($sectionphoto); ?>" alt="" height="146" width="258">
									</div>
									...
									<div  id="landscape">
										<input type="hidden" name="head_photos" id="head_photos" value="<?php echo ($sectionphoto); ?>">
									</div>
								</div>
							</div>
							...
							<div class="n_state">
									<span>状态：</span>
										<span>
											<input type="radio" name="times" checked value="1">
											立即发布
										</span>
										<span>
                            ...
                            <div class="step-btn2 l-confirm">
                                ...
                                <a class="last-step step2-last" href="/Book/Createcomic/comicstep">返回上一步</a>
                            </div>
                       </form>
                        </div>
                    </div>
...
<div class="upload-all-bg">
	...
	<div class="picScroll-left">
		<div class="hd">
			...
			<div class="bd">
				<ul class="picList">
					<?php if(is_array($threedataed)): $i = 0; $__LIST__ = $threedataed;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li id="b<?php echo ($vol["id"]); ?>"><div class='pic' id="a<?php echo ($vol["id"]); ?>"><a><img src="<?php echo ($vol["path"]); ?>" /></a></div></li><?php endforeach; endif; else: echo "" ;endif; ?>
				</ul>
			</div>
			<div class="pagebtn">
...
var uploader = WebUploader.create({
    ...
    server: '/Book/Modifycomi/uploads?val=<?php echo ($val); ?>&&sub=<?php echo ($sub); ?>&&authornumber=<?php echo ($authornumber); ?>',
    pick: '#imgPicker',
...
uploader.on('uploadError', function (file) {
     alert("上传失败,上传图片2M(1000*15000)以內");
  });
</script>
<script>
...
function submited(){
	...
	var timepublish = $("#restore").val();
	
	var choose= document.getElementsByName("times");//类别
