...
<head>
    ...
    <link rel="stylesheet" href="/Public/Book/Face/Css/face.css">
        ...
        <div class="mainContent w1200 clearfix">
            ...
            <div class="creator-right fr p-relative">
                ...
                <div class="r-works work-mananer">
                    ...
                    <div class="create">
                        <div id="create-novel" class="create-novel"><a href="/Book/Createnovel/novelstep"></a></div>
                        <div id="create-comic" class="create-comic"><a href="/Book/Createcomic/comicstep"></a></div>
                    </div>
                </div>
            </div>
        </div>
