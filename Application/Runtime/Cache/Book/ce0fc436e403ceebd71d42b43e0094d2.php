...
<head>
	...
	<title>小说-次元播动漫-<?php echo ($booknames); ?>-<?php echo ($passagetitled); ?></title>
    <link rel="stylesheet" href="/Public/Book/NovelDanmu/Css/noveldanmu.css">
    <link rel="stylesheet" href="/Public/Book/NovelDanmu/Css/public.css">
    <link rel="stylesheet" href="/Public/Book/NovelDanmu/Css/jquery.mCustomScrollbar.css">
    <link rel="stylesheet" href="/Public/Book/NovelDanmu/Css/style.css">
    ...
    <script src="/Public/Book/NovelDanmu/Js/noveldanmu.js"></script>
...
<div id="container" class="player-container clearfix p-relative">
    <div class="readTop">
            ...
            <div class="animate-wrap">
                ...
                <div class="m-nav m-nav-track">
                    <div class="nav-track-middle f-cb">
                        ...
                        <span> > </span>
						<?php if(is_array($Lookpassage)): $i = 0; $__LIST__ = array_slice($Lookpassage,0,1,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><a href="/Book/AuthorNovelmeg/index?vv=<?php echo ($vol["val"]); ?>" class="highlighted bookname f-toe"><?php echo ($vol["bookname"]); ?></a>
							<span> > </span>
							<a class="disabled sectionname f-toe"><?php echo ($vol["passagetitle"]); ?></a><?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                </div>
                <div class="fr topbar-meta-user">
                    <ul class="topbar-user-reader navbar-nav horizontal-list f-cb has-separator">
                        ...
                        <li class="book-shlef dropdown-parent">
                            ...
                            <div id="a-hid" class="a-hismess-hide a-hid danmuhid">
                       ...
                       <?php if(is_array($cc)): foreach($cc as $key=>$vo): ?><!--未登录-->
                        ...
                        <?php if(is_array($dataall)): $i = 0; $__LIST__ = $dataall;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li class="user-link">
                            ...
                            <a class="username col-tex" href="#"><?php echo ($vol["name"]); ?></a>
                            <i class="bigarrow"></i>
     ...
     <div class="read_MakeComplaints">	
        </div>
    
    <div class="comic-danmu-content clearfix p-relative">
		
        <div class="clearfix readMain" style="margin-bottom: 30px;margin-top: 237px;">
            <div class="readCon" style="background-color: rgb(255,255,255);">
                <div class="readcon" style="padding-top: 0px;background-color: rgb(255,255,255);" >
				<?php if(is_array($Lookpassage)): $i = 0; $__LIST__ = $Lookpassage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><h2 class="readbook_title"><?php echo ($vol["passagetitle"]); ?></h2>
                    <div class="readbook_ul_Box">
                        <ul class="clearfix readbook_ul">
                            <li>
                                作者
                                <a href="javascript:;"><?php echo ($vol["author"]); ?></a>
                            </li>
                            <li>更新时间：<?php echo ($vol["time"]); ?></li>
                            <li>字数：<?php echo ($vol["quatityword"]); ?></li>
                            <li>吐槽数：<?php echo ($vol["speak"]); ?></li>
                        </ul>
                    </div>
                    <!--弹幕-->
                    <div id="danmu">
                        <div class="timer d_show" style="display:none;">
							<?php if(is_array($Formsaylovedata)): $i = 0; $__LIST__ = $Formsaylovedata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$kd): $mod = ($i % 2 );++$i;?><div style="color:<?php echo ($kd["type"]); ?>;">
									<span style="margin-left:<?php echo ($kd["heigted"]); ?>px;">
										<!--<img src="<?php echo ($kd["photopath"]); ?>"style="height:40px;width:40px;border-radius:100%;"/>-->
										<?php echo ($kd["contented"]); ?>
									</span>
								</div><?php endforeach; endif; else: echo "" ;endif; ?> 
                        </div>
                    </div>
					...
					<div class="cover-photo">
						<div class="photo-img">
							<img src="<?php echo ($vol["passagephoto"]); ?>" style="width:145px;height:auto;">
						</div>
					</div>
                    <div class="myContent" flag="1">
                        <p style="font-size: 18px;padding:0 80px 5px;line-height: 28px;">
                        ...
                        <div class="yd0-container mCustomScrollbar">
                            <ul class="yd0-body">
								<?php if(is_array($gessyou)): $i = 0; $__LIST__ = $gessyou;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><li>
                                    <h5>
                                        <a href="/Book/AuthorNovelmeg/index?vv=<?php echo ($vol["val"]); ?>"><?php echo ($vol["title"]); ?></a>
                                    </h5>
                                    <div class="cover">
                                        <a href="/Book/AuthorNovelmeg/index?vv=<?php echo ($vol["val"]); ?>">
                ...
                <div class="panel-main js-main a-autoHideDuration"style="bottom: 0;">
                    ...
                    <div class="panel-middle js-middle">
                        <div class="panel-middle-inner">
                            ...
                            <button class="panel-itm panel-btn panel-btn-addTucao curActive">我要来一发</button>
                    ...
                    <div class="panel-right">
                        ...
                        <div class="fr panel-btn panel-itm panel-btn-1 js-catalog "> <i></i>目录
                            <div class="catalog box" style="left: -93px">
                                ...
                                <div class="js-container content catalog-container">
                                    <div>
										<?php if(is_array($passagetitle)): $k = 0; $__LIST__ = $passagetitle;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($k % 2 );++$k; if(($vol["vipe"]) == "0"): ?><div class="js-itm itm f-cb">
												<span class="section f-toe"><a href="/Book/LookNovel/index/cy/<?php echo ($val); ?>/p/<?php echo ($k); ?>.html"><?php echo ($vol["passagetitle"]); ?></a></span>
											</div>
                                        <?php else: ?>
                                ...
                                <div class="catalog-ft">
                                    <span>
                                        共
                                        <span class="js-total"><?php echo ($count); ?></span>
                                        话
                                    </span>
                                </div>
                        ...
                        <!--<button class="fr panel-btn panel-itm panel-btn-1 nextChapter"> <i></i><?php echo ($show); ?></button>-->
                        <div class="fenyePage fl"><?php echo ($show); ?></div>
                        <!--<button class="fr panel-btn panel-itm panel-btn-1 preChapter"> <i></i>上一话</button>-->
                    </div>
                </div>
...
<div class="vipbg" style="display:none;">
        ...
        <div class="new-chapter-content">
            ...
            <div class="openVip">
                <div class="listChapter threeYuan">
                    ...
                    <div class="openBtn"><span><a href="/Book/AuthorNovelmeg/index?vv=<?php echo ($val); ?>&&by=1">马上包养作者</a></span></div>
                </div>
                <div class="listChapter parseChapter">
                    <p class="numMoney">购买此章节</p>
                    <p class="freeRead"><?php echo ($passagetitled); ?></p>
                    <p class="freeRead">VIP会员享8折</p>
                    <div class="openBtn" did="<?php echo ($val); ?>"  numbers="<?php echo ($passageid); ?>" onclick="paythis(this)">
						<span>购买此话39次元币</span>
					</div>
    ...
    <div class="popAll" style="display:none;">
        <div class="popContent">
            ...
            <div class="pay-texts">
                <p>主人，您的余额不足。</p>
                <p>本次将消费<i class="money-num">39</i>次元币，您目前有<?php echo ($coin); ?>次元币</p>
            </div>
...
<div class="enough-money-pop">
    <div class="popContent">
        ...
        <div class="pay-texts">
            <p>主人，确定要购买此章节？</p >
            <p>本次将消费 <i class="vip-money-num">31</i>次元币，您已享8折优惠</p >
        </div>
        <div class="del-pay-btn">
            <span class="delBtn">取消</span>
            <span class="cz_pay"> <a id="money-sure" href="javascript:;">确定</a ></span>
        </div>
        <div class="share-vip">
            <p>VIP享8折优惠 &nbsp;<a href="/Book/SelfMessage/index?pay=1"> 开通 > </a ></p >
        </div>
        <div class="enough-money-close">
            <img src="/Public/Book/ComicDanmu/images/close.png" alt="">
        </div>
    </div>
</div>
    ...
    <div class="cuigeng" style="display: block">
        <div class="cuigeng-main">
            ...
            <div class="cuigeng-nav">
                ...
                <a href="/Book/AuthorNovelmeg/index?vv=<?php echo ($val); ?>" class="cuigeng-nav-href cuigeng-nav-next">
                    去评论
                    <div class="icon">
...
<script>window.jQuery || document.write('<script src="/Public/Book/NovelDanmu/Js/jquery-1.11.0.min.js"><\/script>')</script>
<script src="/Public/Book/NovelDanmu/Js/jquery.mCustomScrollbar.concat.min.js"></script>
</body>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $(".btn-add").click(function(){
            ...
            if(text==""){
             ...
             $.post(
			'/Book/LookNovel/colored?val=<?php echo ($val); ?>&&did=<?php echo ($speakid); ?>&&authornumber=<?php echo ($speakauthornumber); ?>',
			{"colored":colored,"text":text},
			function(data){
				//alert(data);
				    if(data=="1"){
						alert("请登录后再评论,谢谢!");
    ...
    function init_screen(){
        ...
        $(".d_show").find("div").show().each(function(){
            ...
            $(this).css({left:1100,top:_top,color:getReandomColor()});
            var time=31000;
            if($(this).index()%2==0){
                time=31000;
            }
...
<script>
    ...
    $(".pop_close,.delBtn").click(function () {
     ...
     //    金币充足
    $(".enough-money-close,.delBtn").click(function () {
        $(".enough-money-pop").hide();
    });
...
//        VIP&&余额充足
    $(".openBtn").click(function () {
        $(".vip-money-num").html("31");
        $(".enough-money-pop").show();
    });
...
<script type="text/javascript">
    /*   $(window).scroll(function() {
            var b = document.body.scrollHeight-780;
            if ($(this).scrollTop() >= b) {
                var p="<?php echo ($p); ?>";
...
function award(){
	...
	if(money<10){
		alert("余额不足,或您没有登陆!");
		 ...
		 $.post(
			'/Book/LookNovel/award',
			{"money":money,"val":val},
			function(data){
				if(data=="2"){
					alert("催更成功!");
					window.location.href="/Book/AuthorNovelmeg/index?vv=<?php echo ($val); ?>";
				}
		    },
			   "html"
		)
...
　　if(scrollTop + windowHeight == scrollHeight){
		...
		var count ="<?php echo ($count); ?>";
		if(p!=count){
			window.location.href='/Book/LookNovel/index/cy/<?php echo ($val); ?>/p/<?php echo ($mps); ?>.html';
		}else{
			$(".finalyChabg").css('display','block');
		}
　　}
