...
<div class="content">
    ...
    <div class="content_top">&nbsp;&nbsp;&nbsp;现在的位置为：APP操作-&gt 活动Banner（漫画）:</div>
        ...
        <div class="real_c">
            ...
            <table class="table_content" style="display: none">
                ...
                <tr class="tr_list">
                    ...
                    <td>
                        <div class="addLink">
                            <input type="text" id="linkUrl2">
                        </div>
                    </td>
                    <td align="center">
                        <!--<input class="hiddenedid" type="hidden" value="<?php echo ($vol["id"]); ?>">
						<input class="hiddenedval" type="hidden" value="<?php echo ($vol["val"]); ?>">-->
                        <a id="editalText2" class="editalText" href="javascript:;" onclick="editalText(this)" style="text-decoration:none;">编辑内容</a>
                        <a class="editalText">|</a>
                        <a class="editalText" href="javascript:;" onclick="checkno2(this)"  style="text-decoration:none;">保存并上线</a>
                    </td>
                </tr>
                <!--<?php endforeach; endif; ?>-->
                <!-- 操作按钮 -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="add_table" width="100%">
                ...
                <tr>
                    ...
                    <td style="height:200px;">
                        <input type='file' id="appPicture" class="appPicture" name="appPicture"  onclick="uploadone()">
...
<!--漫画与小说的切换-->
<script>
    $(".cartoon-novel>span").each(function (i) {
        $(this).click(function () {
            $(this).addClass("cur_active").siblings().removeClass("cur_active");
            $(".table_content").eq(i).show().siblings("table").hide();
