...
<div class="content">
    ...
    <div class="content_top">&nbsp;&nbsp;&nbsp;现在的位置为：漫画推荐-&gt 长幅活动:</div>
    ...
    <div class="m_content">
        <div class="real_c">
            ...
            <table class="table_content">
                ...
                <tr class="tr_list">
                    <td>次元播作者福利来啦~</td>
                    <td><img src = "<?php echo ($vol["photos"]); ?>" style="width:358px;height:32px;"></td>
                    <td>
                        <div class="netState">
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="add_table" width="100%">
                ...
                <tr>
                    ...
                    <td style="height:200px;">
                        <div>
                            支持JPG,PNG格式，图片大小不超过2M 图片保存尺寸为：648px*59px
                        </div>
                        <div style="height: 60px;margin-top: 64px">
                            <input type='file' id="sortPicture3" class="sortPicture3" name="sortPicture"  onclick="uploadone()">
                            <img src="/Public/Admin/Common/imgs/file3.png"  class="photoca" style="width: 700px;height: 60px">
                        </div>
                    </td>
                </tr>
...
<div class="cutPicture" style="display: none">
    ...
    <div class="cut-pic-content">
        <div class="choosePic3"></div>
        <div class="after-cut-picture2">
            <p>您上传的图片将自动生成654x56的尺寸,
                请注意图片是否清晰
            </p>
            <div class="wrapPicture6"></div>
        </div>
    </div>
