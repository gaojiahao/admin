        ...
        <div class="real_c">
			...
			<table class="table_content">
				...
				<?php if(is_array($data)): foreach($data as $k=>$vo): ?><tr class="tr_top">
							...
							<td>
							    <input id="lookphoto<?php echo ($vo["id"]); ?>" type="hidden" value="<?php echo ($vo["path"]); ?>">
							 　　　<img src="<?php echo ($vo["photopath"]); ?>"  width="220" height="300">
							 </td>
							<td class="bonusmoney">
								<input type="text" placeholder="通过审核不用填写" id = "bonuses<?php echo ($vo["id"]); ?>" name = "bonuses" class="bonuses" style="width:110px;height:35px;">
							</td>
							
							<td align="center">
								<input class="hiddenedid" type="hidden" value="<?php echo ($vo["id"]); ?>">
								<a href="/Admin/Coverpicture/besure?id=<?php echo ($vo["id"]); ?>" style="text-decoration:none;">确认|</a>
