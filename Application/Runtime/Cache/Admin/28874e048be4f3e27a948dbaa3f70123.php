...
<head>
    ...
    <link rel="stylesheet" href="../Common/jedate/skin/jedate.css">
    <script type="text/javascript" src="../Common/Js/jquery-2.2.3.js"></script>
    <script src="../Common/jedate/jquery.jedate.js"></script>
</head>
<style type="text/css">
...
<div class="content">
    ...
    <div class="content_top">&nbsp;&nbsp;&nbsp;现在的位置为：小说推荐-&gt;正在推荐-Banner</div>
        ...
        <div class="real_c">
            ...
            <div class="comicPart">
                ...
                <div class="tab-line">
                    ...
                    |
                    <a href="../Novelcartoonrcm2/novelcartoonrcm2.html">漫改推荐</a>
                    |
                    <a href="../Noveleventrcm2/noveleventrcm2.html">大事件推荐位</a>
                    |
                    <a href="../Novelbest2/novelbest2.html">精品小说</a>
                    |
                    <a href="../Novelhotbookrcm2/novelhotbookrcm2.html">热书推荐</a>
                    |
                    <a href="../Novellongpicrcm2/novellongpicrcm2.html">长幅推荐位</a>
                    |
                    <a href="../Noveleventactrcm2/noveleventactrcm2.html">大事件活动</a>
                    |
                    <a href="../Novellongact2/novellongact2.html">长幅活动</a>
                </div>
                <!--Banner-->
                <table class="table_content">
                    <form name="goodsForm" method="post" action="">
                        ...
                        <?php if(is_array($data)): foreach($data as $k=>$vol): ?><!--banner部分-->
                            <tr class="tr_list">
                                <td>《守墓笔记之少年机关师小说》</td>
                                <td>
                                    大叔阿K
                                ...
                                <td>
                                    <textarea name="intro" cols="30" rows="10" class="intro"></textarea>
                                </td>
                                <td>
                                    55
                                </td>
                                ...
                                <td align="center">
                                    ...
                                    <!--上传后的图片显示-->
                                    <span class="showPicture" style="width: 230px; height: 104px">
                                        <img src="../Common/imgs/hot-novel.png" alt="">
                                        <div class="sp_hover">
                            ...
                            <tr class="tr_list">
                                ...
                                <td align="center">
                                    ...
                                    <!--上传后的图片显示-->
                                    <span class="showPicture" style="width: 170px; height: 111px">
                                        <img src="../Common/imgs/hot-novel.png" alt="">
                                        <div class="sp_hover">
                                            <span class="replace-picture">
                                                替换
...
<div id="cutPicture1" class="comicHome " style="display: none">
    ...
    <div class="cut-pic-content">
        ...
        <div class="after-cut-picture">
            <p>您上传的图片将自动生成718x302的尺寸，<br>
                请注意图片是否清晰
            </p>
            <div class="wrapPicnov"></div>
        </div>
    </div>
...
<div id="cutPicture2" class="comicHome " style="display: none">
    ...
    <div class="cut-pic-content">
        <div class="choosePic4"></div>
        <div class="after-cut-picture">
            <p>您上传的图片将自动生成227*148的尺寸，<br>
                请注意图片是否清晰
            </p>
            <div class="wrapPicnov2"></div>
        </div>
    </div>
    <div class="sure-dele-btn">
        <div class="bottomBtn">
