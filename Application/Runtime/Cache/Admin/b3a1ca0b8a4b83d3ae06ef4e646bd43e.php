...
<head>
    ...
    <!--<link rel="stylesheet" href="Css/newcreasenovel.css">-->
...
<div class="content">
    ...
    <div class="content_top">&nbsp;&nbsp;&nbsp;现在的位置为：新增作品审核-&gt;新增小说</div>
                ...
                <form name="goodsForm" method="post" action="#">
                    ...
                    <tr class="tr_list">
                        ...
                        <td>
                            ...
                            <div style="max-width:350px;height:200px;overflow:scroll;text-align:left;">
...
<div class="avadarPop" style="display: none">
    <div class="headTitle">
        奖励金额
        <i class="close-button" id="closeIcon1"><img src="/Public/Admin/Common/imgs/clsoe.png" alt=""></i>
    </div>
...
<div class="backPop" style="display: none">
    <div class="headTitle">
        驳回
        <i class="close-button" id="closeIcon2"><img src="/Public/Admin/Common/imgs/clsoe.png" alt=""></i>
    </div>
    <div class="textareaBox">
    ...
    <div class="sure-dele-btn">
        <div class="bottomBtn">
            <button type="button" class="sureBtn" id="sendAuthor" onclick="sendAuthor()">发送给作者</button>
            <button type="button" class="deleteBtn" id="deletepop" onclick="deletepop()">取消</button>
        </div>
    </div>
</div>

<!--小说预览-->
<div class="lookNovelPop" style="display: none">
    <div class="picClose">
        <img src="/Public/Admin/Common/imgs/picclose.png" alt="">
    </div>
    <div class="pictureContent">
        <div class="novelChapter" style="width:800px;height:auto; position:absolute;
         left:50%;margin-left:-400px;background:#fff !important;padding:28px;">
            <?php if(is_array($Formpassagedata)): foreach($Formpassagedata as $key=>$vo): ?><div style="text-align:center;">
                    <span style="font-size:20px;font-weight:bold;"><?php echo ($vo["bookname"]); ?></span>
                    <span style="font-size:10px;margin-left:10px;"><?php echo ($vo["author"]); ?></span>
                </div>
                <div style="text-align:center;margin-top:20px;"><h3><?php echo ($vo["section"]); ?></h3></div>
                <div style="text-align:center;margin-top:20px;"><h4><?php echo ($vo["passagetitle"]); ?></h4></div>
                <div style="margin-top:20px;font-size:20px;word-break: normal;"><?php echo ($vo["content"]); ?></div><?php endforeach; endif; ?>
...
<script>
    ...
    //    图片预览
    function relook() {
        $(".noticePop,.lookNovelPop").show();
    }
    //  ×掉
    $(".picClose").click(function () {
        $(".noticePop,.lookNovelPop") .hide();
    });
</script>
</body>
</html>