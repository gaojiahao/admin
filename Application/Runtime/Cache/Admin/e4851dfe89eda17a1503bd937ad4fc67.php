...
<div class="content">
    ...
    <div class="content_top">&nbsp;&nbsp;&nbsp;现在的位置为：动态-&gt活动公告:</div>
    ...
    <div class="real_c">
        ...
        <form name="article_add" method="post" action="">
            <table border="0" cellpadding="0" cellspacing="0" id="add_table" width="100%">
                ...
                <tr>
                    <td class="left_td">动态类别：</td>
                    <td class="right_td">
                        <select name="kind" id="kind" style="width:80px;height:24px;">
                            <option value="新闻">新闻</option>
                            <option value="通知">通知</option>
                            <option selected value="活动">活动</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    <td class="left_td">添加时间：</td>
                    <td class="right_td">
                        <input type="text" name="time" class="input" value="<?php echo ($time); ?>" id="srcname"  style="min-width:870px;width: 100%;">
                    </td>
                </tr>
