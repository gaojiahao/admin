...
<head>
    ...
    <link rel="stylesheet" href="/Public/Admin/Common/Css/jquery.tagsinput.css">
    <script type="text/javascript" src="/Public/Admin/Common/Js/jquery-2.2.3.js"></script>
    <script src="/Public/Admin/Common/Js/jquery.tagsinput.js"></script>
</head>
<style type="text/css">
...
<div class="content">
    ...
    <div class="content_top">&nbsp;&nbsp;&nbsp;现在的位置为：APP操作-&gt社区banner:</div>
    ...
    <div class="m_content">
        <div class="real_c">
            ...
            <table class="table_content">
                ...
                <tr class="tr_list">
                    <td>次元播作者福利来啦~</td>
                    <td><img src = "<?php echo ($vol["photos"]); ?>" style="width:250px;height:117px;"></td>
                    <td>
                        <div class="netState">
        ...
        <form name="article_add" method="post" action="">
            <table border="0" cellpadding="0" cellspacing="0" id="add_table" width="100%">
                ...
                <tr style="width: 980px">
                    <td class="left_td">添加标签：</td>
                    <td>
                        <input id="tags" type="text" class="tags" name="tags" value style="display: none">
                ...
                <tr>
                    <td class="left_td">隐藏内容：</td>
                    <td style="background-color: #fff">
                        <div class="wrap-textare-img">
                            <div class="textarea-content">
                                <textarea name="hiddentext" id="hiddentext"></textarea>
                            </div>
                            <div class="wrap-uploadimg">
                                <div class="uploadBtn">
                                    <input type="file">
                                    <img src="/Public/Admin/Common/imgs/uploadimg.png" alt="">
                                </div>
                            </div>
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td style="height:200px;">
                        <input type='file' id="appPicture" class="appPicture" name="appPicture"  onclick="uploadone()" style="width: 303px;height: 142px;">
                        <img src="/Public/Admin/Common/imgs/appicon.png"  class="photoca" style="width: 303px;height: 142px;">
                        <div class="paths2"  id="imageadd" style="margin-top: -10px">
