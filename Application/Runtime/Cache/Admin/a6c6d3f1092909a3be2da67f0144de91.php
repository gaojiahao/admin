...
<div class="content">
    ...
    <div class="content_top">&nbsp;&nbsp;&nbsp;现在的位置为：认证申请-&gt;认证详情</div>
                ...
                <form name="goodsForm" method="post" action="">
                    ...
                    <tr class="tr_list">
                        ...
                        <td align="center">
                            ...
                            <a href="javascript:;" onclick="checksure(this)" style="text-decoration:none;">同意</a>
                            |
...
<div class="agreePop" style="display: none">
    ...
    <div class="textareaBox">
        <div class="tipSendText">作者大大您好，恭喜您，您的作品《我根本不是主角啊喂》已通过认证申请，
            快去建立自己的领域邀请粉丝一起互动交流吧！o(´^｀)o~~
        </div>
    </div>
...
<!--驳回后弹出框-->
<div class="disagreePop" style="display: none; height: 300px">
    <div class="headTitle tabLine">
        驳回
        <i class="close-button"><img src="/Public/Admin/Common/imgs/clsoe.png" alt=""></i>
    </div>
    <div class="textareaBox">
        <div class="tipSendText" style="height: 140px">
            <p>作者大大您好，很遗憾的通知您，您的作品《我根本不是主角啊喂》暂时未通过我们的作者认证，
                无法建立自己的领域，请不要气馁，
            </p>
            <p>
                大大可以先努力更新作品，宣传自己的作品，到时候认证通过的几率将会很多哦~
            </p>
            <p>期待下次再次申请，次元播动漫将与您同行！</p>
            <p>【作者认证每个月仅可申请1次】</p>
        </div>
    </div>
    <div class="sure-dele-btn">
