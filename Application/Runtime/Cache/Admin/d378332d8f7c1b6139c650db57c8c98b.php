...
<div class="content">
    ...
    <div class="content_top">&nbsp;&nbsp;&nbsp;现在的位置为：小说推荐-&gt 大事件活动:</div>
    ...
    <div class="m_content">
        <div class="real_c">
            ...
            <table class="table_content">
                ...
                <tr class="tr_list">
                    <td>次元播作者福利来啦~</td>
                    <td><img src = "<?php echo ($vol["photos"]); ?>" style="width:298px;height:96px;"></td>
                    <td>
                        <div class="netState">
            ...
            <table border="0" cellpadding="0" cellspacing="0" id="add_table" width="100%">
                ...
                <tr>
                    ...
                    <td style="height:200px;">
                        ...
                        <img src="/Public/Admin/Common/imgs/file4.png"  class="photoca2" style="width: 302px;height: 98px;">
                        <div class="paths"  id="imageadd">
                            支持JPG,PNG格式，图片大小不超过2M 图片保存尺寸为：298px*96px
                        </div>
                    </td>
                </tr>
