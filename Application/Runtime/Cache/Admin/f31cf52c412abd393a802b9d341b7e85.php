...
<div class="content">
    ...
    <div class="content_top">&nbsp;&nbsp;&nbsp;现在的位置为：内容审核-&gt;漫画审核</div>
            ...
            <table class="table_content">
                <form name="goodsForm" method="post" action="">
                    ...
                    <tr class="tr_list">
                        ...
                        <td>
                            <img src="imgs/58d1fc4b1b0b9.jpg"  sb="<?php echo ($date["id"]); ?>" height="140" width="100">

                        </td>

                        <td>
                            <img src="imgs/58d1fc4b1b0b9.jpg" sb="<?php echo ($date["id"]); ?>" height="170" width="95">
